    ...
    <section id="bannerType" class="banner__wrap" :class="attr">
        ...
        <div class="banner__inner">
            ...
            <p class="desc">
                ...
                <a href="https://sukjun2.tistory.com/" title="티스토리로 이동"> https://sukjun2.tistory.com/ </a>
            </p>
            <span class="small">추석은 압박의 명절</span>
        </div>
    </section>
</template>
...
/* bannerType */
.banner__inner {
    background-image: url(../../assets/img/w_banner_bg01.jpg);
