...
.imgText__img.img1 {
    background: url(../../assets/img/w_imgText_bg01.jpg) no-repeat center / cover;
}
.imgText__img.img2 {
    background: url(../../assets/img/w_imgText_bg02.jpg) no-repeat center / cover;
}
/* media */
